...
strong = Se utiliza para poner importancia, seriedad o urgencia al texto que contiene
...
<body>
    ...
    if (isset($_GET['error'])) {
        ...
        if ($error == 'apellidos') {
            echo '<strong style="color:red">Introducir apellidos correctamente</strong>';
        }
        ...
        if ($error == 'email') {
            echo '<strong style="color:red">Escribe el correo correcto</strong>';
        }
        if ($error == 'password') {
            echo '<strong style="Color:red">introduce un contraseña minimo de 5 caracteres </strong>';
        }
    }
